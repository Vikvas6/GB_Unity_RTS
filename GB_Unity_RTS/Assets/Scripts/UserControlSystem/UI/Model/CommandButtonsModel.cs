...
public class CommandButtonsModel
{
    ...
    [Inject] private CommandCreatorBase<ISetDestinationCommand> _setDester;
    ...
    public void OnCommandButtonClicked(ICommandExecutor commandExecutor, ICommandsQueue commandsQueue)
    {
            ...
            _setDester.ProcessCommandExecutor(commandExecutor, command => executeCommandWrapper(command, commandsQueue));
    }
